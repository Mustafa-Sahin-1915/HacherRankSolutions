...
or instance is an instanceof the specified type.
...
In the main method, we populated an ArrayList with several
instances of these classes.
count method calculates how many instances of each type is present in the ArrayList.
The code prints three integers,
the number of instance of Student class,
the number of instance of Rockstar class,
...
public class Q050 {
    static String count(ArrayList mylist){
        ...
        for(int i = 0; i < mylist.size(); i++){
            ...
            if(element instanceof Student3)
            a++;
    ...
    public static void main(String []args){
        ...
        for(int i=0; i<t; i++){
            String s=sc.next();
            if(s.equals("Student"))mylist.add(new Student3());
