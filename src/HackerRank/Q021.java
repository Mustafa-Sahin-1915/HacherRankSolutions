...
*
* Note: This challenge uses a custom checker;
* you will fail the challenge if you modify anything other than the three locations
* that the comments direct you to complete. To restore the editor's original stub code,
* create a new buffer by clicking on the branch icon in the top left of the editor.
*
* Input Format
...
Each of the n subsequent lines contains a single sentence consisting of English alphabetic
* letters and whitespace characters.
* Output Format

Stub code in the editor prints the sentence modified by the replaceAll line to stdout.
* The modified string must be a modified version of the initial sentence
* where all repeat occurrences of each word are removed.
*
* Sample Input
...
1. We remove the second occurrence of bye and the second and third occurrences of world from
* Goodbye bye bye world world world to get Goodbye bye world.
2. We remove the second occurrence of went and
* the second and third occurrences of to from Sam went went to to to his business
* to get Sam went to his business.
3. We remove the second occurrence of is,
* the second occurrence of the, and the second occurrence of eye from Reya is is the the best player
* in eye eye game to get Reya is the best player in eye game.
